...
<amp-sidebar id="sidebarPromo"
  ...
  <amp-img class="amp-close-imagepromo"
    ...
    tabindex="0"></amp-img>
    <img
    src="content/img/208-promov.jpg"
    width="360"
    height="640"
    alt="close sidebar"
    layout="responsive"
    ...
    <div class="contenido-promocion">
        <p>Bono de hasta $40,000 al financiamiento para Gama 301 AM 2017, AM2018 y AM2019 y Gama 208 AM2017, AM2018 (excepto GT) desde 10% de enganche a 60 meses.</p><br>
...
<!-- PROMOCIONES  -->
    ...
    <div id="btn-promo" on="tap:sidebarPromo.toggle">
...
<section id="seccion-cuatro301" class="col-12 main-content">
    <div id="interior-contenido301" class="contenido-diseno-interno col-12">
        <amp-img class="titleEx" src="content/img/tx-modernidad.png" width="329" height="76" layout="responsive" sizes="(min-width: 229px) 229px, 100vw" alt= "Peugeot 301"></amp-img>
                ...
                <div id="wrapper">
                        <div id="carousel">
                            <div id="overview">
                                ...
                                <p role="button" tabindex="2" on="tap:detailinterior-5" id="link-5" class="w3-animate-zoom"></p>
                            </div>
                            <amp-lightbox id="detailinterior-1" layout="nodisplay">
                                <div class="lightbox" on="tap:detailinterior-1.close" role="button" tabindex="0">
                                    ...
                                    <p id="textointerioruno">
                                        ...
                                        El Peugeot i-Cockpit®, el cual proporciona una experiencia de conducción intuitiva, ágil y segura.</p>
                                </div>
                            </amp-lightbox>
                            <amp-lightbox id="detailinterior-2" layout="nodisplay">
                                <div class="lightbox" on="tap:detailinterior-2.close" role="button" tabindex="1">
                                    ...
                                    <p id="textointeriordos">
                                        ...
                                        Cuenta con un volante compacto, ajustable que se encuentra en una posición ergonómica, que evita la fatiga del conductor.</p>  
                                </div>
                            </amp-lightbox>
                            <amp-lightbox id="detailinterior-3" layout="nodisplay">
                                <div class="lightbox" on="tap:detailinterior-3.close" role="button" tabindex="2">
                                    ...
                                    <p id="textointeriortres">
                                        ...
                                        Líneas precisas  y delicadas, hacen que a primera  vista  el Peugeot 208, llame la atención, poniendo de manifiesto su frescura y juventud.</p>  
                                </div>
                            </amp-lightbox>
                            ...
                            <amp-lightbox id="detailinterior-5" layout="nodisplay">
                                <div class="lightbox" on="tap:detailinterior-5.close" role="button" tabindex="2">
                                    <p class="close">X</p>
                                    <amp-img id="detailinteriortres" src="content/img/open-camarareversa.png" media="(min-width: 650px)"  width="1280" height="580" layout="responsive" sizes="(min-width: 1480px) 1480px, 100vw" alt="Peugeot 208"></amp-img>
                                    <amp-img id="detailinteriortresmobile" src="content/img/open-camarareversa.jpg" media="(max-width: 649px)" width="640" height="1280" sizes="(min-width: 640px) 6400px, 100vw" layout="responsive" alt="Peugeot 208"></amp-img>
                                    <p id="textointeriortres">
                                        <span>Rendimiento Total</span><br>
                                        El consumo de energía es una de las prestaciones que hacen del nuevo Peugeot 208 un auto que se adapta a todas las necesidades de conducción.</p>  
                                </div>
                            </amp-lightbox>
                        </div>
                    </div>
    ...
    <div id="exterior-contenido301" class="backgroundexterior col-12">
        <amp-position-observer on="enter:slideTransition.start; exit:slideTransition.start,slideTransition.reverse" intersection-ratios="0.5" layout="nodisplay"></amp-position-observer>
            <amp-img id="titlediseno" class="titleEx" src="content/img/tx-modernidad.png" width="329" height="76" layout="responsive" sizes="(min-width: 229px) 229px, 100vw" alt= "Peugeot 208" ></amp-img>
            ...
            <div id="carousel-exterior">
                ...
                <amp-lightbox id="detail-farostraseros" layout="nodisplay">
                    ...
                    <p id="textodetailuno">
                        ...
                        Faros de LED, delanteros y traseros de alta tecnología, se vuelven la firma del Peugeot 208.</p>
                </div>
                </amp-lightbox>
                <amp-lightbox id="detail-parrilla" layout="nodisplay">
                    ...
                    <p id="textodetaildos">
                        ...
                        El Peugeot 208 nos presenta elementos de diseño visibles, como los detalles cromados en la carrocería que le imprimen un estilo único.</p>   
                    </div>
                </amp-lightbox>
                <amp-lightbox id="detail-carroceria" layout="nodisplay">
                    ...
                    <p id="textodetailtres">
                        ...
                        El nuevo diseño de las luces traseras 3D LED que sorprenden y cautivan a primera vista, proporcionando un acabado rojo opalino, homogéneo y un efecto 3D, que los hacen una joya tecnológica.</p>
                    </div>
                </amp-lightbox>
            </div>
        </div>
...
<section id="seccion-precios" class="precios-content col-12 main-content">
        ...
        <amp-carousel id="precioscarousel" height="300"
            ...
            <div class="carousel-cars">
                <amp-img src="content/img/208-blanco-ch.png"
                ...
                <div id="color" class="colorbar col-12">
                    ...
                    Allure HDi<br><br><br><br>
                    <span>$286,900</span>
                    </p>
            </div>
            <div class="carousel-cars">
                <amp-img src="content/img/208-gris-ch.png"
                ...
                <div id="color" class="colorbar col-12">
                    ...
                    <p id="describeprecios">
                        ...
                        más Allure HDi<br><br>
                        <span>$299,900</span>
                    </p>
            </div>
            <div class="carousel-cars">
                <amp-img src="content/img/208-negro-ch.png"
                ...
                <div id="color" class="colorbar col-12">
                        ...
                        <div class="colornegro" role="button" tabindex="0" on="tap:AMP.setState({carsprecio: {currentCarThird: 'gris'}})"></div>
                    </div>
                    <p id="describeprecios">
                    Allure Pack<br>
                    Equipamiento base<br>
        ...
        <div id="moveprecios" class="background-precio col-12">
            <div id="carpreciouno" class="preciobar">
                <amp-img id="imgpreciocaruno" src="content/img/208-blanco-ch.png" [src]="carsprecio[carsprecio.currentCar].imageUrl" width="244" height="137" sizes="(min-width: 244px) 244px, 100vw" layout="responsive" alt="301 blanco"></amp-img>
                <div id="color" class="colorbar col-12">
                    <div role="button" tabindex="0" class="colorwhite" on="tap:AMP.setState({carsprecio: {currentCar: 'blanco'}})"></div>
                    <div role="button" tabindex="1" class="colorgris" on="tap:AMP.setState({carsprecio: {currentCar: 'gris'}})"></div>
                </div>
                <p id="describeprecios">
                    Allure HDi<br><br><br><br>
                    <span>Desde $286,900</span>
                </p>
            </div>
            <div id="carpreciodos" class="preciobar">
                <amp-img id="imgpreciocardos" src="content/img/208-gris-ch.png" [src]="carsprecio[carsprecio.currentCarSecond].imageUrl" width="244" height="137" sizes="(min-width: 244px) 244px, 100vw" layout="responsive" alt="301 gris artense"></amp-img>
                <div id="color" class="colorbar col-12">
                    <div role="button" tabindex="0" class="colorwhite" on="tap:AMP.setState({carsprecio: {currentCarSecond: 'blanco'}})"></div>
                    <div role="button" tabindex="1" class="colorgris" on="tap:AMP.setState({carsprecio: {currentCarSecond: 'gris'}})"></div>
                </div>
                <p id="describeprecios">
                        PureTech<br>
                        Equipamiento base<br>
                        más Allure HDi<br><br>
                        <span>Desde $299,900</span>
                </p>
            </div>
            <div id="carpreciotres" class="preciobar">
                <amp-img id="imgpreciocartres" src="content/img/208-negro-ch.png" [src]="carsprecio[carsprecio.currentCarThird].imageUrl" width="244" height="137" sizes="(min-width: 244px) 244px, 100vw" layout="responsive" alt="301 gris moka"></amp-img>
                <div id="color" class="colorbar col-12">
                    <div role="button" tabindex="0" class="colormoka" on="tap:AMP.setState({carsprecio: {currentCarThird: 'gris'}})"></div>
                    <div role="button" tabindex="1" class="colornegro" on="tap:AMP.setState({carsprecio: {currentCarThird: 'negro'}})"></div>
                </div>
                <p id="describeprecios">
                    Allure Pack<br>
                    Equipamiento base<br>
                    más Puretech<br><br>
                    <span>Desde $314,900</span>
                </p>
            </div>
        </div>
