...
<div id="btn-promo" role="button" tabindex="0" on="tap:sidebarPromo.toggle">
    ...
    <amp-img src="content/img/bt-promocion.png" media="(max-width: 649px)"  width="95" height="97" layout="responsive" sizes="(min-width: 55px) 45px, 100vw" role="button" tabindex="0" on="tap:sidebarPromo.toggle"></amp-img>
</div>
<!-- BOTON 208  -->
...
<script src="content/js/velocity.ui.min.js"></script>
