            ...
            <div id="carousel-exterior">
                ...
                <amp-lightbox id="detail-farostraseros" layout="nodisplay">
                    ...
                    <p id="textodetailuno">
                        ...
                        Peugeot 301, es el auto más equipado de la gama, con un diseño y detalles altamente cuidados, que harán de tu conducción, una experiencia digna de vivirse. El comportamiento dinámico del nuevo sedán Peugeot 301, garantiza un compromiso de muy alto nivel entre confort y comportamiento en carretera en las distintas condiciones de conducción.</p>
                </div>
                </amp-lightbox>
                <amp-lightbox id="detail-parrilla" layout="nodisplay">
                    ...
                    <p id="textodetaildos">
                        ...
                        Con un motor desarrollado para ofrecer gran rendimiento, y equipado con lo último en tecnología, el Peugeot 301 es el ejemplo de elegancia, robustez y modernidad. El nuevo PEUGEOT 301 está equipado con un eficiente motor HDi de 1.6l con 92Hp, el cuál asociado a una transmision manual de 5 velocidades ofrece una excelente síntesis entre flexibildad de uso y consumo, logrando una autonomía de hasta 27 km/lt.</p>   
                    </div>
                </amp-lightbox>
                ...
                <amp-lightbox id="detail-techo" layout="nodisplay">
                    ...
                    <p id="textodetailcinco">
                        ...
                        Con un diseño de última generación que combina  tecnología y funcionalidad, con la eficiencia cotidiana. El nuevo PEUGEOT 301, adopta los últimos códigos estilísticos de la marca. Con un aspecto robusto y muy moderno, el nuevo sedán PEUGEOT 301 hacen patente la elegancia y el carácter combinados en un solo vehículos.</p>
                    </div>
                </amp-lightbox>
            </div>
        </div>
...
<section id="seccion-precios" class="precios-content col-12 main-content">
        ...
        <amp-carousel id="precioscarousel" height="500"
            ...
            type="slides">
            <div>
                <img id="imgpreciocarunom" src="content/img/301blancog.png"
                    width="280"
                    height="126"
                    class="carmobile"
                    alt="Peugeot 301">
                ...
                <div id="color" class="colorbar col-12">
                        <div class="colorwhite" role="button" tabindex="0" onClick="changeCarB('imgpreciocarunom','blanco')"></div>
                        <div class="colorgris" role="button" tabindex="0"  onClick="changeCarB('imgpreciocarunom','gris')"></div>
                    </div>
                    <p id="describeprecios">
                        <span class="title-prices-main">ACTIVE</span><br><br><br>
                        <span class="bold-listo">INTERIOR<span><br>
                        <span class="parrafo-listo">Controles de audio al volante</span><br><br>
                        <span class="bold-listo">EXTERIOR<span><br>
                        <span class="parrafo-listo">Faros traseros con efecto 3 garras</span><br><br>
                        <span class="bold-listo">SEGURIDAD<span><br>
                        <span class="parrafo-listo">Frenos ABS</span><br><br>
                        <span class="bold-listo">MOTOR<span><br>
                        <span class="parrafo-listo">1.6VTI 115hp</span><br><br>
                        <span class="preciospan title-prices-main">Desde $244,900</span>
                    </p>
            </div>
            <div>
                <img id="imgpreciocardosm" src="content/img/301grisartenseg.png"
                    width="280"
                    height="126"
                    class="carmobile"
                    alt="Peugeot 301">
                ...
                <div id="color" class="colorbar col-12">
                        <div class="colorwhite" role="button" tabindex="0" onClick="changeCarB('imgpreciocardosm','blanco')"></div>
                        <div class="colorgris" role="button" tabindex="0" onClick="changeCarB('imgpreciocardosm','gris')"></div>
                    </div>
                    <p id="describeprecios">
                        <span class="title-prices-main">ACTIVE</span><br><br><br>
                        <span class="bold-listo">INTERIOR<span><br>
                        <span class="parrafo-listo">Apertura de cajuela desde interior</span><br><br>
                        <span class="bold-listo">EXTERIOR<span><br>
                        <span class="parrafo-listo">Faros de niebla</span><br><br>
                        <span class="bold-listo">SEGURIDAD<span><br>
                        <span class="parrafo-listo">Control de estabilidad ESP</span><br><br>
                        <span class="bold-listo">MOTOR<span><br>
                        <span class="parrafo-listo">1.6HDi 92hp</span><br><br>
                        <span class="title-prices-main">Desde $256,900</span>
                    </p>
            </div>
            <div>
                <img id="imgpreciocartresm" src="content/img/301grismokag.png"
                    width="280"
                    height="126"
                    class="carmobile"
                    alt="Peugeot 301">
                ...
                <div id="color" class="colorbar col-12">
                        <div class="colormoka" role="button" tabindex="0" onClick="changeCarB('imgpreciocartresm','grismoka')"></div>
                        <div class="colornegro" role="button" tabindex="0" onClick="changeCarB('imgpreciocartresm','negro')"></div>
                    </div>
                    <p id="describeprecios">
                        <span class="title-prices-main">ALLURE</span><br>
                        <span class="texto-precios-min">Equipamiento Active más:</span><br><br>
                        <span class="bold-listo">INTERIOR<span><br>
                        <span class="parrafo-listo">Cámara de reversa</span><br><br>
                        <span class="bold-listo">EXTERIOR<span><br>
                        <span class="parrafo-listo">Retrovisores regulables eléctricamente</span><br><br>
                        <span class="bold-listo">SEGURIDAD<span><br>
                        <span class="parrafo-listo">Asistencia en Frenado de Urgencia AFU</span><br><br>
                        <span class="bold-listo">MOTOR<span><br>
                        <span class="parrafo-listo">1.6HDi 92hp </span><br><br>
                        <span class="title-prices-main">Desde $285,900</span>
                    </p>
            </div>
            <div>
                <img id="imgpreciocarcuatrom" src="content/img/301negroperlag.png"
                width="280"
                    height="126"
                    class="carmobile"
                    alt="Peugeot 301">
                ...
                <div id="color" class="colorbar col-12">
                        <div class="colormoka" role="button" tabindex="0" onClick="changeCarB('imgpreciocarcuatrom','grismoka')"></div>
                        <div class="colornegro"  role="button" tabindex="0" onClick="changeCarB('imgpreciocarcuatrom','negro')"></div>
                    </div>
                    <p id="describeprecios">
                        <span class="title-prices-main">ALLURE</span><br>
                        <span class="texto-precios-min">Equipamiento Active más:</span><br><br>
                        <span class="bold-listo">INTERIOR<span><br>
                        <span class="parrafo-listo">Pantalla táctil de 7"</span><br><br>
                        <span class="bold-listo">EXTERIOR<span><br>
                        <span class="parrafo-listo">Guía de luz diurna led</span><br><br>
                        <span class="bold-listo">SEGURIDAD<span><br>
                        <span class="parrafo-listo">Bolsas de aire laterales</span><br><br>
                        <span class="bold-listo">MOTOR<span><br>
                        <span class="parrafo-listo">1.6VTI 115hp</span><br><br>
                        <span class="title-prices-main">Desde $292,900</span>
                    </p>
                </div>
        </amp-carousel>
        <div id="moveprecios" class="background-precio col-12">
            <div id="carpreciouno" class="preciobar">
                <img id="imgpreciocaruno" src="content/img/301blanco.png" class="auto-mini" alt="301 blanco"></img>
                <div id="color" class="colorbar col-12">
                    <div class="colorwhite" role="button" tabindex="0" onClick="changeCarB('imgpreciocaruno','blanco')"></div>
                    <div class="colorgris" role="button" tabindex="0" onClick="changeCarB('imgpreciocaruno','gris')"></div>
                </div>
                <p id="describeprecios">
                    <span class="title-prices-main">ACTIVE</span><br><br><br>
                    <span class="bold-listo">INTERIOR<span><br>
            ...
            <div id="carpreciodos" class="preciobar">
                <img id="imgpreciocardos" src="content/img/301grisartenseg.png" class="auto-mini" alt="301 gris artense"></img>
                <div id="color" class="colorbar col-12">
                    <div class="colorwhite" role="button" tabindex="0"  onClick="changeCarB('imgpreciocardos','blanco')"></div>
                    <div class="colorgris" role="button" tabindex="0" onClick="changeCarB('imgpreciocardos','gris')"></div>
                </div>
                <p id="describeprecios">
                    <span class="title-prices-main">ACTIVE</span><br><br><br>
                    <span class="bold-listo">INTERIOR<span><br>
            ...
            <div id="carpreciotres" class="preciobar">
                <img id="imgpreciocartres" src="content/img/301grismokag.png" class="auto-mini" alt="301 gris moka"></img>
                <div id="color" class="colorbar col-12">
                    <div class="colormoka" role="button" tabindex="0"  onClick="changeCarB('imgpreciocartres','grismoka')"></div>
                    <div class="colornegro" role="button" tabindex="0" onClick="changeCarB('imgpreciocartres','negro')"></div>
                </div>
                <p id="describeprecios">
                    <span class="title-prices-main">ALLURE</span><br>
                    <span class="texto-precios-min">Equipamiento Active más:</span><br><br>
            ...
            <div id="carpreciocuatro" class="preciobar">
                <img id="imgpreciocuatro" src="content/img/301negroperlag.png" class="auto-mini" alt="301 negro perla"></img>
                <div id="color" class="colorbar col-12">
                    <div class="colormoka" role="button" tabindex="0" onClick="changeCarB('imgpreciocuatro','grismoka')"></div>
                    <div class="colornegro" role="button" tabindex="0" onClick="changeCarB('imgpreciocuatro','negro')"></div>
                </div>
                <p id="describeprecios">
                    <span class="title-prices-main">ALLURE</span><br>
                    <span class="texto-precios-min">Equipamiento Active más:</span><br><br>
